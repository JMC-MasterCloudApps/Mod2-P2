...
public class DatabaseInitializer {
	...
	public void init() {
		...
		bookRepository.save(new Book(titles[0],
		...
		bookRepository.save(new Book(titles[1],
		...
		bookRepository.save(new Book(titles[2],
		...
		bookRepository.save(new Book(titles[3],
		...
		bookRepository.save(new Book(titles[4],
